...
# Check the file to make sure it has the correct user:group ownership and permissions. 
# This command will set the files owner to root:root, regardless of what it should be.
# 
